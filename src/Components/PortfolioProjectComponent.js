    ...
    return (
        <div class="w3-black">
            <nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center">
                ...
                <a href="#about" class="w3-bar-item w3-button w3-padding-large w3-black project-sidebar-item">
                    <p>PORTFOLIO WEBSTIE</p>
                </a>
                <a href="#" class="w3-bar-item w3-button w3-padding-large w3-black project-sidebar-item">
                    <p>WEATHER APP</p>
                </a>
                <a href="#projects" class="w3-bar-item w3-button w3-padding-large w3-black project-sidebar-item">
